...
Una vez añadido el servidor, debemos configurar la conexión al mismo con la autenticación básica HTTP con usuario y contraseña (solo si tenemos la autenticación de verificación en dos pasos descativada, en caso contrario tendremos que autenticar con **OAuth2**):
  ...
  <center><img src="{{ site.baseurl }}/images/general.png" alt="General" width="450"></center>
...
Tras esto, accedemos a la pestaña de **Server Configuration** donde debemos especificar las diferentes llamas REST para poder consultar las tareas en nuestro _tracker_.
  ...
  <center><img src="{{ site.baseurl }}/images/config.png" alt="Server Configuration" width="450"></center>
  ...
  <center><img src="{{ site.baseurl }}/images/mapping.png" alt="Mapping" width="450"></center>
...
<center><img src="{{ site.baseurl }}/images/git_flow.png" alt="Git Flow" width="450"></center>
...
<center><img src="{{ site.baseurl }}/images/open_task.png" alt="Open Task" width="450"></center>
...
<center><img src="{{ site.baseurl }}/images/master.png" alt="Git" width="450"></center>
